...
cred = credentials.Certificate("C:/Users/raksh/Downloads/home-sec-b65fd-firebase-adminsdk-yt34w-cd68046109.json")
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://home-sec-b65fd-default-rtdb.firebaseio.com/'
})
############################################# FUNCTIONS ################################################
...
def TrackImages():
    ...
    assure_path_exists("personDetails/")
    assure_path_exists("DetectedImages/") 
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if (conf < 50):
                ...
                img_filename = "DetectedImages/ID_" + str(ID) + "_" + str(timeStamp).replace(':', '-') + ".jpg"
                cv2.imwrite(img_filename, face_img)
                db.reference('home').set({'Name': bb})
                print(f"Detected: {bb}")
            else:
                Id = 'Unknown'
                bb = str(Id)
                db.reference('home').set({'Name':'1'})
                print(f"Detected: {bb}")
            cv2.putText(im, str(bb), (x, y + h), font, 1, (255, 255, 255), 2)
        cv2.imshow('finding persons', im)
...
takeImg = tk.Button(frame2, text="Take person Images", command=TakeImages  ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save person data", command=psw ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="find person from survilance", command=TrackImages  ,fg="black"  ,bg="yellow"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
